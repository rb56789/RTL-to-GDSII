...
#  Created on Tue Sep  3 13:46:09 2024                
#                                                     
#######################################################
...
fit
setIoFlowFlag 0
floorPlan -site gsclib090site -r 0.660146699267 0.698615 10.15 10.15 10.15 10.15
uiSetTool select
getIoFlowFlag
fit
...
addStripe -nets {VDD VSS} -layer Metal1 -direction horizontal -width 1.8 -spacing 1.8 -number_of_sets 5 -start_from left -switch_layer_over_obs false -max_same_layer_jog_length 2 -padcore_ring_top_layer_limit Metal9 -padcore_ring_bottom_layer_limit Metal1 -block_ring_top_layer_limit Metal9 -block_ring_bottom_layer_limit Metal1 -use_wire_group 0 -snap_wire_center_to_grid None
undo
setAddStripeMode -ignore_block_check false -break_at none -route_over_rows_only false -rows_without_stripes_only false -extend_to_closest_target none -stop_at_last_wire_for_area false -partial_set_thru_domain false -ignore_nondefault_domains false -trim_antenna_back_to_shape none -spacing_type edge_to_edge -spacing_from_block 0 -stripe_min_length stripe_width -stacked_via_top_layer Metal9 -stacked_via_bottom_layer Metal1 -via_using_exact_crossover_size false -split_vias false -orthogonal_only true -allow_jog { padcore_ring  block_ring } -skip_via_on_pin {  standardcell } -skip_via_on_wire_shape {  noshape   }
...
ui_view_box
ui_view_box
dbquery -area {-37.5705 -4.7995 180.8305 100.7895} -objType inst
dbquery -area {-37.5705 -4.7995 180.8305 100.7895} -objType regular
dbquery -area {-37.5705 -4.7995 180.8305 100.7895} -objType special
setDrawView fplan
setDrawView ameba
setDrawView place
