...
set z ksa8
			...
			read_hdl /home/vlsi_39/Desktop/Rohit_Bhatt/Pj/KSA8/kog_stone8.v
			...
			report_area >> KSA_8_$y-$x.area.txt
			report_power >> KSA_8_$y-$x.power.txt
			report_timing -unconstrained >> KSA_8_$y-$x.timing.txt
